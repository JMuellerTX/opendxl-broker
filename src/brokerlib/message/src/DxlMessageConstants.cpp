...
const char* DxlMessageConstants::PROP_TLS_VERSION = "tlsVersion";
const char* DxlMessageConstants::PROP_TLS_CIPHER = "cipher";
const char* DxlMessageConstants::PROP_CERT_THUMBPRINT = "certThumbprint";
const char* DxlMessageConstants::PROP_REMOTE_ADDRESS = "remoteAddress";
const char* DxlMessageConstants::PROP_TRANSPORT = "protocol";
